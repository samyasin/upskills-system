                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 text-center">
                        <ul class="hero-area-tree">
                            <li><a href="index-ar.php">الدورات</a></li>
                            <li></li>
                        </ul>
                        <h1 class="white-text">تفاصيل الدورات</h1>
                    ...
                    <div id="main" class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<a href='blog-post-ar.php?course_id={$row['course_id']}'>";
                                echo "<img src='uploads/{$row['course_image']}' height='409' width='273'></a></div>";
                                echo" <h4><a href='blog-post-ar.php?course_id={$row['course_id']}'>{$row['course_ar_name']}</a></h4>";
